...
<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-top:50px;margin-left:50px;">
    ...
    <tr>
        ...
        <td align="left" class="l-table-edit-td"><input name="menu.status" type="text" id="menu.status" ltype="text" value="${requestScope.menu.status}"/></td>
        <td align="left"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td align="left" class="l-table-edit-td"><input name="menu.createtime" type="text" id="menu.createtime" ltype="text" value="${requestScope.menu.createtime}"/></td>
        <td align="left"></td>
    </tr>
    <tr>
