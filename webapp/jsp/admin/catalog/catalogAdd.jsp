...
<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-top:50px;margin-left:50px;">
    ...
    <tr>
    	...
    	<td align="left" class="l-table-edit-td"><input name="catalog.status" type="text" id="catalog.status" ltype="text" /></td>
    	<td align="left"></td>
    </tr>
    <tr>
    ...
    <tr>
    	...
    	<td align="left" class="l-table-edit-td"><input name="catalog.menuId" type="text" id="catalog.menuId" ltype="text" /></td>
    	<td align="left"></td>
    </tr>
    <tr>
    	<td align="right" class="l-table-edit-td">创建时间：</td>
    	<td align="left" class="l-table-edit-td"><input name="catalog.createtime" type="text" id="catalog.createtime" ltype="text" /></td>
    	<td align="left"></td>
    </tr>
    <tr>
