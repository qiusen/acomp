...
function f_initGrid(){
    g = manager = $("#maingrid").ligerGrid({
		...
		{ display: '密码', name: 'password',type: 'text' , width: '15%'},
...
function deleteData(id){
    if (confirm('确定删除?')){
    	window.location="${base}/admin/manager/managerAction!delete.${actionExt}?id=" + id;
    }
}
function showData(id){
	var dialog=$.ligerDialog.open({ title:'查看', url: '${base}/admin//manager/managerAction!show.${actionExt}?id=' + id, height: 300, width: null, buttons: [
