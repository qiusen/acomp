...
$(document).ready(function(){
    ...
    //liger.get("listbox2").setData([{"siteName":"新东方教育","id":11},{"siteName":"搜狐教育","id":2}]);
...
<body>
<form name="linkPageForm" id="linkPageForm" method="post" action="linkPageAction!addSave.${actionExt}" onsubmit="return checkForm();">
<input type="hidden" id="links" name="links" value="" />
<table cellpadding="0" cellspacing="0" class="l-table-edit" style="margin-top:50px;margin-left:50px;">
    <tr>
    	<td align="right" class="l-table-edit-td">页面名称：</td>
    	<td align="left" class="l-table-edit-td"><input name="linkPage.pageName" type="text" id="linkPage.pageName" ltype="text" /></td>
    	<td align="left"></td>
    </tr>
    <tr>
    	<td align="right" class="l-table-edit-td">页面名称：</td>
    	<td align="left" class="l-table-edit-td"><input name="pageName" type="text" id="pageName" ltype="text" />.html</td>
    	<td align="left"></td>
    </tr>
    <tr>
    	<td align="right" class="l-table-edit-td">页面简介：</td>
    	<td align="left" class="l-table-edit-td"><input name="linkPage.description" type="text" id="linkPage.description" ltype="text" /></td>
    	<td align="left"></td>
    </tr>
    <tr>
    ...
    <tr>
    	<td align="center" colspan="3">
    	<input type="submit" value="保存并发布" id="Button1" class="l-button l-button-submit" /> 
